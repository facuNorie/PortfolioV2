    ...
    <article id='skills ' style={{ marginTop: '200px' }}>
      ...
      <Flex wrap='wrap' justify='center'>
        ...
        <Flex
          ...
          my={3}
        >
          <svg role='img' viewBox='0 0 24 24' style={{ width: '4rem' }}>
            <path
              style={{ filter: colorMode === 'light' ? '' : 'invert(100%)' }}
        ...
        <Flex
          ...
          my={3}
        >
          <svg role='img' viewBox='0 0 24 24' style={{ width: '5rem' }}>
            <path
              style={{ filter: colorMode === 'light' ? '' : 'invert(100%)' }}
          ...
          <Text fontWeight='bold'>Styled-components</Text>
        </Flex>
        <Flex
          w={{ base: '50%', md: '33%' }}
          direction='column'
        ...
        >
          ...
          <Text fontWeight='bold'>Material-UI</Text>
        </Flex>
      </Flex>
    </article>
  );
